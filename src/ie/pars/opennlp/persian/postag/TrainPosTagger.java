...
public class TrainPosTagger {
    ...
    public static void main(String[] ss) throws IOException {
        ...
        Reader s = new FileReader(new File(
                //"lang/fa/pos/train-set-all"
                "lang/fa/pos/trainset-upos-bj-m"
       ...
       // pot.setTagDictionary(loadPosDictionary());
        ...
        modelOut = new BufferedOutputStream(new FileOutputStream("lang/fa/fa-pos.bin"));
        model.serialize(modelOut);

        modelOut.close();

        System.out.println("Lets eva");
        EvaluatePosTagger.main(ss);
    }
    ...
    public static final TrainingParameters parameters() {
        ...
        mlParams.put(TrainingParameters.ITERATIONS_PARAM, Integer.toString(30));
