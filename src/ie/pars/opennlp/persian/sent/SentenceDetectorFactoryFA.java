 ...
 * resources
 */
public class SentenceDetectorFactoryFA extends BaseToolFactory {
   ...
   */
  public SentenceDetectorFactoryFA() {
  }
   ...
   * @param eosCharacters
   */
  public SentenceDetectorFactoryFA(String languageCode, boolean useTokenEnd,
  ...
  public static SentenceDetectorFactoryFA create(String subclassName,
      String languageCode, boolean useTokenEnd,
      Dictionary abbreviationDictionary, char[] eosCharacters)
      throws InvalidFormatException {
    if (subclassName == null) {
      // will create the default factory
      return new SentenceDetectorFactoryFA(languageCode, useTokenEnd,
          abbreviationDictionary, eosCharacters);
    }
    try {
      SentenceDetectorFactoryFA theFactory = ExtensionLoader
          .instantiateExtension(SentenceDetectorFactoryFA.class, subclassName);
