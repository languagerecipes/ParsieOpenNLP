 ...
 */
public class GetBijankhanGnetiveTags {
    ...
    public static void main(String[] s) throws FileNotFoundException {
        ...
        try {
            ...
            PrintWriter pw = new PrintWriter(new FileWriter(new File("lang/fa/pos/trainset-gen-marker")));
...
//                    sent += " ";
//                }
                    sent += " " + wordToken + "_" + PoSUtil.getGenTag(posToken);
                }
            }
            br.close();
            pw.close();
            ...
            System.out.println(file);
            Logger.getLogger(GetBijankhanGnetiveTags.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
